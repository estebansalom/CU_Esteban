...
function registrar_Usuarios(paInfoUsuario) {
    ...
    let peticion = $.ajax({
        ...
        data: {
            ...
            nombre_usuario: paInfoUsuario[2],
            primer_apellido_usuario: paInfoUsuario[3],
            segundo_apellido_usuario: paInfoUsuario[4],
            cedula_usuario: paInfoUsuario[5],
            fecha_usuario: paInfoUsuario[6],
            correo_usuario: paInfoUsuario[7],
            telefono_usuario: paInfoUsuario[8],
            direccion_usuario: paInfoUsuario[9],
            provincia_usuario: paInfoUsuario[10],
            canton_usuario: paInfoUsuario[11],
            distrito_usuario: paInfoUsuario[12],
            rol_usuario: paInfoUsuario[12],
            estado_usuario: paInfoUsuario[14],
        }
    });
